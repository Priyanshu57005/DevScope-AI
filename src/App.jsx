...
const Header = () => (
  <header className="sticky top-0 z-50 w-full border-b border-[var(--border)] bg-[var(--bg-secondary)]/80 backdrop-blur-md">
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center gap-3">
      ...
      {/* Nav accent badge */}
      <div
        className="hidden sm:flex items-center gap-1.5 text-xs text-[var(--text-muted)] px-3 py-1.5 rounded-full border border-[var(--border)] bg-[var(--bg-card)]"
  ...
  <footer className="border-t border-[var(--border)] py-6 text-center">
    ...
    >
      ...
      <a
        ...
        className="text-[var(--accent-soft)] hover:text-[var(--accent)] transition-colors"
      >
        GitHub REST API
      </a>
    </p>
